...
save(datExpr, datMeta, dds, top_genes, file=paste0('/data/TCGA-',project,'/mRNA/mRNA_processed.RData'))
...
dds <- diff_expr_res$dds
top_genes <- diff_expr_res$top_genes
save(datExpr, datMeta, dds, top_genes, file=paste0('/data/TCGA-',project,'/miRNA/miRNA_processed.RData'))
...
datExpr <- count_mtx
save(cpg_sites , datExpr , datMeta , file = paste0('/data/TCGA-',project,'/DNAm/DNAm_processed.RData'))
...
datExpr <- count_mtx
save(protein_sites , datExpr , datMeta , file = paste0('/data/TCGA-',project,'/RPPA/RPPA_processed.RData'))
...
datExpr <- count_mtx
save(cnv_sites , datExpr , datMeta , file = paste0('/data/TCGA-',project,'/CNV/CNV_processed.RData'))