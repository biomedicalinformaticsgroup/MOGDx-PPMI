...
write.csv(datExpr_filt , file = paste0('/data/',dataset , '/raw/',dataset,'/Feature_Importance/',project,'/',modality,'/',modality,'_datExpr.csv'))
...
saveRDS(gene_list, file = paste0('/data/',dataset , '/raw/',dataset,'/Feature_Importance/',project,'/',modality,'/',modality,'_DEGs.rds'))